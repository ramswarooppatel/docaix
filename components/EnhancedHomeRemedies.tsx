...
export const EnhancedHomeRemedies: React.FC<HomeRemediesProps> = ({
  ...
  if (!enhancedAdvice || !enhancedAdvice.severity_assessment || !enhancedAdvice.home_remedies) {
    console.warn("EnhancedHomeRemedies: Invalid or incomplete enhancedAdvice data");
    return (
      <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
        <p className="text-yellow-800">Enhanced advice data is incomplete. Please try again.</p>
      </div>
    );
  }
  ...
  const tabs = [
    { id: "immediate", label: "Immediate Relief", icon: Clock },
    { id: "natural", label: "Natural Remedies", icon: Leaf },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {activeTab === "immediate" && (
          <div className="space-y-4">
            ...
            {enhancedAdvice.step_by_step_treatment && enhancedAdvice.step_by_step_treatment.length > 0 && (
        ...
        {activeTab === "natural" && enhancedAdvice.home_remedies.natural_treatments && enhancedAdvice.home_remedies.natural_treatments.length > 0 && (
          <div className="space-y-4">
            ...
            {/* Dietary Remedies */}
            {enhancedAdvice.home_remedies.dietary_remedies && enhancedAdvice.home_remedies.dietary_remedies.length > 0 && (
        ...
        {/* Lifestyle Tab */}
        {activeTab === "lifestyle" && enhancedAdvice.home_remedies.lifestyle_adjustments && enhancedAdvice.home_remedies.lifestyle_adjustments.length > 0 && (
          <div className="space-y-4">
            ...
            {/* Household Items */}
            {enhancedAdvice.needed_products?.household_items && enhancedAdvice.needed_products.household_items.length > 0 && (
              <Card className="border-green-200 bg-green-50/30">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-green-800">
        ...
        {activeTab === "products" && (
          <div className="space-y-4">
            {/* Pharmacy Items */}
            {enhancedAdvice.needed_products?.pharmacy_items && enhancedAdvice.needed_products.pharmacy_items.length > 0 && (
            ...
            {/* Herbal Supplements */}
            {enhancedAdvice.needed_products?.herbal_supplements && enhancedAdvice.needed_products.herbal_supplements.length > 0 && (
              <Card className="border-green-200 bg-green-50/30">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-green-800">
                    <Leaf className="w-5 h-5" />
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-3">
                    {enhancedAdvice.needed_products.herbal_supplements.map((supplement, index) => (
            ...
            {/* Grocery Items */}
            {enhancedAdvice.needed_products?.grocery_items && enhancedAdvice.needed_products.grocery_items.length > 0 && (
              <Card className="border-orange-200 bg-orange-50/30">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-orange-800">
                    <ShoppingCart className="w-5 h-5" />
                    Grocery Items for Recovery
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid md:grid-cols-3 gap-3">
          ...
          <Card className="border-indigo-200 bg-indigo-50/30">
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                {/* Prevention Tips */}
                {enhancedAdvice.prevention_tips && enhancedAdvice.prevention_tips.length > 0 && (
                  <div className="mt-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                      {enhancedAdvice.prevention_tips.map((tip, index) => (
                        <div key={index} className="flex items-start gap-3 p-3 bg-white rounded-lg border border-indigo-200">
                          <Lightbulb className="w-4 h-4 text-indigo-600 flex-shrink-0 mt-1" />
      ...
      {enhancedAdvice.warning_signs && enhancedAdvice.warning_signs.length > 0 && (
